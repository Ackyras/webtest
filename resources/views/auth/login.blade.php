...
@section('content')
        ...
        <div class="sign-in-from">
            ...
            <form class="mt-4" method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control mb-0 @error('password') is-invalid @enderror" name="password"
    ...
    <div class="col-sm-6 text-center">
        <div class="sign-in-detail text-white">
            <a class="sign-in-logo mb-5" href="#"><img src="{{ asset('assets/dashboard/images/logo-white.png') }}" class="img-fluid"
                    alt="logo"></a>
